...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        ...
        qno.setFont(new Font("Mongolian Baiti", Font.BOLD, 23));
        add(qno);

        question = new JLabel("");
        question.setBounds(150, 350, 900, 30);
        question.setFont(new Font("Mongolian Baiti", Font.BOLD, 25));
        add(question);
...
//        
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == next) {
            ...
            ans_given = 1;
            if (groupoptions.getSelection() == null) {//if user has selected any option
                useranswers[count][0] = "";
            } else {
    ...
    public void paint(Graphics g) {
        ...
        if (timer > 0) {
            ...
            g.drawString("Times UP!!!", 1000, 380);
        }
        timer--;
        ...
        if (ans_given == 1) {//user has given the ans
            ans_given = 0;
            timer = 15;

        } else if (timer < 0) {//if timer ends to 0
            timer = 15;
            opt2.setEnabled(true);
            opt3.setEnabled(true);
            opt1.setEnabled(true);
